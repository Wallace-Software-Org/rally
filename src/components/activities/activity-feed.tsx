...
import { ActivityCardMobile, ActivityCardDesktop } from '@/components/activities/activity-card'
    ...
    <div className="h-screen flex flex-col bg-white dark:bg-zinc-950 overflow-hidden">
      ...
      <div className="hidden lg:flex flex-1 overflow-hidden">
        ...
        <MapPanel
          ...
          onDotClick={id => setSelectedId(prev => prev === id ? null : id)}
        >
          {selectedActivity && (
            <MapPreviewCard
