...
// Pins standing for more than one activity at the same coordinates. Sized to fit
// a two-digit count, and proportional to the single-pin pair above.
export const PIN_SIZE_GROUP = 26;
export const PIN_SIZE_GROUP_SELECTED = 32;
