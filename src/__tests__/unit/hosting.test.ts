...
describe("hostingTabCount", () => {
  it("counts only upcoming, non-cancelled activities", () => {
    ...
    expect(hostingTabCount(activities, NOW)).toBe(1);
  });
});
